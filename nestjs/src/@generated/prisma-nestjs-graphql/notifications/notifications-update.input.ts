...
import { UserUpdateOneRequiredWithoutNotificationsInput } from '../user/user-update-one-required-without-notifications.input';
...
export class NotificationsUpdateInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutNotificationsInput, {nullable:true})
