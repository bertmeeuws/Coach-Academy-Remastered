...
import { ExerciseInWorkoutUpdateManyWithoutExerciseInput } from '../exercise-in-workout/exercise-in-workout-update-many-without-exercise.input';
...
export class ExerciseUpdateInput {
    ...
    @Field(() => ExerciseInWorkoutUpdateManyWithoutExerciseInput, {nullable:true})
    ExerciseInWorkout?: ExerciseInWorkoutUpdateManyWithoutExerciseInput;
}
