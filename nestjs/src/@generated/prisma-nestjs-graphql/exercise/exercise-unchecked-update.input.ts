...
import { ExerciseInWorkoutUncheckedUpdateManyWithoutExerciseInput } from '../exercise-in-workout/exercise-in-workout-unchecked-update-many-without-exercise.input';
...
export class ExerciseUncheckedUpdateInput {
    ...
    @Field(() => ExerciseInWorkoutUncheckedUpdateManyWithoutExerciseInput, {nullable:true})
    ExerciseInWorkout?: ExerciseInWorkoutUncheckedUpdateManyWithoutExerciseInput;
}
