...
import { ExerciseInWorkoutCreateNestedManyWithoutExerciseInput } from '../exercise-in-workout/exercise-in-workout-create-nested-many-without-exercise.input';
...
export class ExerciseCreateInput {
    ...
    @Field(() => ExerciseInWorkoutCreateNestedManyWithoutExerciseInput, {nullable:true})
    ExerciseInWorkout?: ExerciseInWorkoutCreateNestedManyWithoutExerciseInput;
}
