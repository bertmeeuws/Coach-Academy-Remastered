...
import { NestedEnumMUSCLE_GROUPWithAggregatesFilter } from './nested-enum-muscle-group-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMUSCLE_GROUPFilter } from './nested-enum-muscle-group-filter.input';

@InputType()
export class EnumMUSCLE_GROUPWithAggregatesFilter {
